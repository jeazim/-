...
public class FindStaff implements ActionListener{
    ...
    JComponent toFind()
    {
        ...
        JButton jBInformation = new JButton("详细信息");
        JButton jBDeleteCurrentRecord = new JButton("删除当前记录");
        JButton jBDeleteAllRecords = new JButton("删除所有记录");
//        jBQuery.setPreferredSize(new Dimension(100,50));
//        jBQueryAll.setPreferredSize(new Dimension(300,50));
//        jBInformation.setPreferredSize(new Dimension(200,50));
//        jBDeleteCurrentRecord.setPreferredSize(new Dimension(100,50));
//        jBDeleteAllRecords.setPreferredSize(new Dimension(100,50));
        // 设置监听
...
//                jTFSAddress.setText((String) v.get(5));// 住址
        ...
        //Label label =new Label("员工信息查询表",JLabel.CENTER);
        //label.setText("选择查询字段");
        pp1.add(label);
